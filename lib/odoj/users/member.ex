defmodule Odoj.Users.Member do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Odoj.Repo)
  ...
  """
  def valid_password?(%Odoj.Users.Member{hashed_password: hashed_password}, password)
